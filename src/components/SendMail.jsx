      ...
      <div className="p-8 mb-3">
        ...
        <div>
          ...
          <label className="input input-bordered flex items-center gap-2 my-3">
              <FaUser />
              <input type="text" className="grow text-black" placeholder="Name" name="user_name" />
            </label>
            <label className="input input-bordered flex items-center gap-2 my-3">
              <svg
              ...
              <input type="text" className="grow text-black" placeholder="Email" name="user_email" />
            </label>
            <textarea
              placeholder="Message"
              name="message"
              className="textarea textarea-bordered textarea-md w-full text-black mt-3"
            ></textarea>
            <button
              type="submit"
